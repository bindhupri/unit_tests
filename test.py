...
with beam.Pipeline(options=pipeline_options) as p:
    (
        ...
        | 'Add Commas' >> beam.ParDo(AddComma())
        | 'Write to File' >> WriteToText(output_json_path, num_shards=1, shard_name_template='', append_trailing_newlines=True)
    )
